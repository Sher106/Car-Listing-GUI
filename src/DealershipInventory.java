...
public class DealershipInventory {
    ...
    public void list(int Year, String Make, String Model, String VIN, String Mileage, String Cost, boolean cleanRecord, String carImage2) {
        if (count == Inventory.length) {
            increaseSize();
        }
        Inventory[count] = new Car(Year, Make, Model, VIN, Mileage, Cost, cleanRecord, carImage2);
        count++;
    }
